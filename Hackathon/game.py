...
from pfish import Bee, Spongebob
import cv2
import ui
import random
...
class Game:
    def __init__(self, surface):
        ...
        self.song=["Assets/Sounds/mixkit-sword-cutting-flesh-2788.wav"]#,"Assets/Sounds/mixkit-sword-cutting-and-killing-2168.wav"]
        self.sounds = {}
        self.sounds["slap"] = pygame.mixer.Sound(f"{random.choice(self.song)}")
